...
host_sel_dsk_port:	equ	0xF4 
host_sd_cmd_port:       equ 	0xF5 
host_conout_port:       equ     0xFE 
host_conin_port:        equ     0xFE 
host_concmd_port:       equ     0xFF 
host_const_port:        equ     0xFF 

host_cls_cmd:           equ     0xFF 

host_read_block_cmd:    equ 	0x10 
host_write_block_cmd:   equ 	0x11 
...
con_tx_char: 
	ld	a,c 
	out	(host_conout_port),a	; send the character 
	ret 
